...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      width: size.width,
      height: GetPlatform.isAndroid? 200 : 235,
      child: Container(
          ...
          child: Column(
            children: [
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        ...
                        Expanded(child: Stack(
                          children:[
                           ...
                           Center(
                             child:  Transform.rotate(angle: 1.5, child: Icon(Icons.local_airport_rounded,color:isColor == null ? Colors.white: const Color(0xFFBACCF7))),
                           )
                          ]
                        ),
                        ),
                    ...
                    Row(
                      ...
                      children: [
                        SizedBox(width: 100,child: Text(ticket['from']['name'], style:isColor == null ? Styles.headlineStyle4.copyWith(color: Colors.white): Styles.headlineStyle4),),
                        Text(ticket['flying_time'], style: isColor == null ? Styles.headlineStyle3.copyWith(color:Colors.white):Styles.headlineStyle3),
                        SizedBox(width: 100,child: Text(ticket['to']['name'], textAlign: TextAlign.end, style: isColor == null ? Styles.headlineStyle4.copyWith(color: Colors.white):Styles.headlineStyle4),),
              ...
              // Showing the orange partof the ticket
              Container(
